...
coverage of $90.0\%$ with and have size scaling factors of $\hat{t} = 0.996$ and $\hat{t} = 0.944$, respectively. These are consistent 
with the coverage results reported for all three methods in Section~\ref{sec5.1.2: dimensionality scaling}.
...
efficiency (reaching only $\hat{t} = 1.212$ at $K=20$), and outperforms the radial method by using axis aligned pairwise projections. 
...
\caption{Dimensionality scaling experiment ($K \in \{2,5,10,20\}$, nominal $1-\alpha = 0.900$, $N = 2\,000$). Empirical 
