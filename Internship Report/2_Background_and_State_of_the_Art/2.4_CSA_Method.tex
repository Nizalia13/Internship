...
\vspace{0.15cm}
\noindent The first set, $S_1$ is used to determine the geometric shape of the optimized envelope. Let's call it the 
`Shape Discovery Set', it is used to map the distribution of the scores and then learn the geometry of the multi-dimensional
...
\vspace{0.15cm}
\noindent The second set, $S_2$, or the `Size Scaling Set' is used to determine the global scaling factor $\hat t \in 
