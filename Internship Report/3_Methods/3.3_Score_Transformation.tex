...
The raw functional category scores $s_k \in [0, 1]$ quantify evidence in favor of functional compatibility, therefore a raw 
...
To map all the score vectors into one unified nonconformity space near the origin, we define label-dependent 
