...
\noindent A single convex envelope $E_{\text{conv}} = \operatorname{conv}\left(\bigcup_{h \in \mathcal{H}} \mathcal{C}_h \right)$ 
...
\noindent Test points falling in this gap are included in the prediction set by construction, $|C(\mathbf{s})|$, and they make 
